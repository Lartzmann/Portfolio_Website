...
import ProjectImg1 from "../assets/Todo_UI.png"
import ProjectImg2 from "../assets/advice_thumb.png"
import ProjectImg3 from "../assets/age_thumb.png"
  ...
  const projects = [
    {
      ...
      demoLink: "https://todo-app-akyt.vercel.app/",
      codeLink: "#",
    },
    {
      image: ProjectImg2,
      ...
      demoLink: "https://advice-generator-app-main-psi-blue.vercel.app/",
      codeLink: "#",
    },
    {
      image: ProjectImg3,
      ...
      demoLink: "https://age-calculator-app-main-sage.vercel.app/",
      codeLink: "#",
    },
    {
      image: ComingSoonImg,
    ...
    {
      image: ComingSoonImg,
      title: "Music Store – Coming Soon",
      description:
        "An e-commerce web application inspired by platforms like Thomann, built to showcase and sell musical instruments and studio equipment. Focused on clean UI, product browsing efficiency, and a real-world store experience — with features like categorized product listings, responsive design, and a seamless user shopping flow — stay tuned!",
      // demoLink: "#",
      codeLink: "#",
    },
    // {
