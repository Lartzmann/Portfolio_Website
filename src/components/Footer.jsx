...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-[#0f172a] to-[#1e293b] text-gray-400 py-8 mt-16">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-4">
        ...
        <div className="flex gap-6 text-2xl">
          {/* <a
            href="mailto:teyemmmanuel01@gmail.com?subject=Hello&body=I%20wanted%20to%20reach%20out..."
